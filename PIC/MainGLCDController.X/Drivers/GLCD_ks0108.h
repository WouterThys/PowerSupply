...
*           FUNCTIONS
*******************************************************************************/
#define GLCD_DrawVertLine(x, y, length) GLCD_FillRect(x, y, 0, length, WHITE)
#define GLCD_DrawHoriLine(x, y, length) GLCD_FillRect(x, y, length, 0, BLACK)
...
#define GLCD_WriteText(x, y, txt) GLCD_GotoXY(x, y); GLCD_Puts(txt);
#define GLCD_DrawDot(x, y) GLCD_SetDot(x, y, BLACK);
#define GLCD_ClearDot(x, y) GLCD_SetDot(x, y, WHITE);
